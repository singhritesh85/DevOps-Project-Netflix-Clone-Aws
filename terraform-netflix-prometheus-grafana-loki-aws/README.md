# terraform-netflix-prometheus-grafana-loki-aws
```
1. First of all clone this repository and change the directory to "terraform-netflix-prometheus-grafana-loki-aws".
...
3. Provide SSH Private Key in the file user_data_blackbox_exporter.sh, user_data_grafana.sh, user_data_jenkins_master.sh, user_data_jenkins_slave.sh, user_data_loki.sh, user_data_prometheus.sh and user_data_sonarqube.sh
